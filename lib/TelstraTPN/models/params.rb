...
module TelstraTPN
  ...
  class Params
    ...
    def hash
      [description, duration, bandwidth, latency, linkid, contractid, price, tag, connections, topology_tag_uuid, billing_id, renewal_option, latency_sla, linkstatus, link_type].hash
    end
