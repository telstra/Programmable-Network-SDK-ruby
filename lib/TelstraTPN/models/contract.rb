...
module TelstraTPN
  class Contract
    ...
    def hash
      [contractid, duration, bandwidth, price, contract_status, version, deletedtimestamp, currency_code, currency_id, renewal_option, contract_start_time, contract_end_time].hash
    end
