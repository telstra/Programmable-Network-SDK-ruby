...
module TelstraTPN
  class Createcontractrequest
    ...
    def list_invalid_properties
      ...
      if !@bandwidth.nil? && @bandwidth > 10000
        invalid_properties.push('invalid value for "bandwidth", must be smaller than or equal to 10000.')
      end

      if !@bandwidth.nil? && @bandwidth < 1
        invalid_properties.push('invalid value for "bandwidth", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@bandwidth.nil? && @bandwidth > 10000
      return false if !@bandwidth.nil? && @bandwidth < 1
      true
    end
    ...
    def bandwidth=(bandwidth)
      if !bandwidth.nil? && bandwidth > 10000
        fail ArgumentError, 'invalid value for "bandwidth", must be smaller than or equal to 10000.'
      end

      if !bandwidth.nil? && bandwidth < 1
        fail ArgumentError, 'invalid value for "bandwidth", must be greater than or equal to 1.'
      end
    ...
    def hash
      [duration, bandwidth, renewal_option].hash
    end
