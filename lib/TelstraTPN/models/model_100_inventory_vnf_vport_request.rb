...
module TelstraTPN
  ...
  class Model100InventoryVnfVportRequest
    # 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'management_port')
        self.management_port = attributes[:'management_port']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          vnfuuid == o.vnfuuid &&
          management_port == o.management_port
    end
    ...
    def hash
      [customeruuid, vnfuuid, management_port].hash
    end
