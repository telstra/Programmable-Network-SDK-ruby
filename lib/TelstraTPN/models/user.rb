...
module TelstraTPN
  ...
  class User
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'usercountry')
        self.usercountry = attributes[:'usercountry']
      end
      ...
      if attributes.has_key?(:'jobtitle')
        self.jobtitle = attributes[:'jobtitle']
      end
      ...
      if attributes.has_key?(:'phoneext')
        self.phoneext = attributes[:'phoneext']
      end

      if attributes.has_key?(:'phonetype')
        self.phonetype = attributes[:'phonetype']
      end
    ...
    def list_invalid_properties
      ...
      if @useruuid.nil?
        invalid_properties.push("invalid value for 'useruuid', useruuid cannot be nil.")
      end
    ...
    def hash
      [useruuid, status, title, usercountry, emailaddress, jobtitle, firstname, middlename, lastname, phonenumber, phoneext, phonetype].hash
    end
