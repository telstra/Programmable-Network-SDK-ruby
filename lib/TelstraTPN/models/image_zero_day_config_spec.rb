...
module TelstraTPN
  class ImageZeroDayConfigSpec
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'conf_type')
        self.conf_type = attributes[:'conf_type']
      end
    ...
    def hash
      [conf_type, count, create_at, creator, file_name, id, name, owner, updated_at].hash
    end
