...
module TelstraTPN
  ...
  class Model100InventoryLinksResponse
    # 
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'linkStatus')
        self.link_status = attributes[:'linkStatus']
      end
    ...
    def hash
      [description, latency, linkid, contracts, tag, connections, type, link_status, topology_tag_uuid, billing_id].hash
    end
