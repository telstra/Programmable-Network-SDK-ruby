...
module TelstraTPN
  ...
  class Topology
    ...
    # no longer used
    attr_accessor :nsd_uuid

    # 
    attr_accessor :guid_topology_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nsd_uuid')
        self.nsd_uuid = attributes[:'nsd_uuid']
      end

      if attributes.has_key?(:'guid_topology_id')
        self.guid_topology_id = attributes[:'guid_topology_id']
      end
      ...
      if attributes.has_key?(:'deletion_date')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nsd_uuid == o.nsd_uuid &&
          guid_topology_id == o.guid_topology_id &&
    ...
    def hash
      [uuid, name, description, status, customer_uuid, nsd_uuid, guid_topology_id, created_by, creation_date, deletion_date].hash
    end
