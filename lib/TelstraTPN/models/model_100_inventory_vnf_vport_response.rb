...
module TelstraTPN
  ...
  class Model100InventoryVnfVportResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vnportuuid')
        self.vnportuuid = attributes[:'vnportuuid']
      end
