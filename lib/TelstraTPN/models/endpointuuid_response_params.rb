...
module TelstraTPN
  ...
  class EndpointuuidResponseParams
    ...
    attr_accessor :latency_sla

    attr_accessor :link_type

    attr_accessor :linkid

    attr_accessor :linkstatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'latency-sla')
        self.latency_sla = attributes[:'latency-sla']
      end
      ...
      if attributes.has_key?(:'linkstatus')
        self.linkstatus = attributes[:'linkstatus']
      end
    ...
    def hash
      [bandwidth, billing_id, connections, contractid, description, duration, latency, latency_sla, link_type, linkid, linkstatus, price, renewal_option, tag, topology_tag_uuid].hash
    end
