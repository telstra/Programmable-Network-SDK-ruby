...
# Unit tests for TelstraTPN::InlineResponse20010
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20010' do
  before do
    # run before each test
    @instance = TelstraTPN::InlineResponse20010.new
  end
  ...
  describe 'test an instance of InlineResponse20010' do
    it 'should create an instance of InlineResponse20010' do
      expect(@instance).to be_instance_of(TelstraTPN::InlineResponse20010)
    end
  end
